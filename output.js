//Sat Jun 29 2024 05:00:02 GMT+0000 (Coordinated Universal Time)
...
//Modify:https://github.com/smallfawn/decode_action
{
  (() => {
    var b = {
              ...
              _doReset: function () {
                if (!this._nRounds || this._keyPriorReset !== this._key) {
                  ...
                  for (this._invKeySchedule = [], V = this._invKeySchedule = [], W = 0, void 0; W < S; W++) {
                    ...
                    W < 4 || U <= 4 ? V[W] = X : V[W] = G[A[X >>> 24]] ^ H[A[X >>> 16 & 255]] ^ I[A[X >>> 8 & 255]] ^ J[A[255 & X]];
                  }
                }
              },
        ...
        165: function (f, g, h) {
          var k;
          f.exports = (k = h(21), h(506), k.lib.Cipher || function (q) {
            A.Cipher = D.extend({
              cfg: B.extend(),
            ...
            P.OpenSSL = {
              stringify: function (V) {
                var W,
                  X = V.ciphertext,
                  Y = V.salt;
                Y ? W = C.create([1398893684, 1701076831]).concat(Y).concat(X) : W = X;
                return W.toString(F);
              },
              parse: function (V) {
                var X,
        ...
        21: function (f, g, h) {
          ...
          f.exports = (k = k || function (q, v) {
            var x;
            "undefined" != typeof window && window.crypto && (x = window.crypto);
            "undefined" != typeof self && self.crypto && (x = self.crypto);
            "undefined" != typeof globalThis && globalThis.crypto && (x = globalThis.crypto);
            !x && "undefined" != typeof window && window.msCrypto && (x = window.msCrypto);
            !x && 0 !== h.g && h.g.crypto && (x = h.g.crypto);
            if (!x) {
              try {
                x = h(477);
              } catch (L) {}
            ...
            B.WordArray = C.extend({
              init: function (M, N) {
                M = this.words = M || [];
                N != v ? this.sigBytes = N : this.sigBytes = 4 * M.length;
              },
              toString: function (M) {
            ...
            B.BufferedBlockAlgorithm = C.extend({
              ...
              _process: function (M) {
                var N,
                  ...
                  S = 4 * R,
                  T = Q / S;
                M ? T = q.ceil(T) : T = q.max((0 | T) - this._minBufferSize, 0);
                var U = T * R,
                  V = q.min(4 * U, Q);
                if (U) {
                  for (var W = 0; W < U; W += R) {
        ...
        25: function (f, g, j) {
          var l, m, p, q, u, v, w;
          f.exports = (l = j(21), m = l, p = m.lib, q = p.Base, u = m.enc, v = u.Utf8, w = m.algo, w.HMAC = q.extend({
            init: function (y, z) {
          ...
          f.exports = (k = h(21), function () {
            if ("function" == typeof ArrayBuffer) {
              q.init = function (w) {
                ...
                (w instanceof Int8Array || "undefined" != typeof Uint8ClampedArray && w instanceof Uint8ClampedArray || w instanceof Int16Array || w instanceof Uint16Array || w instanceof Int32Array || w instanceof Uint32Array || w instanceof Float32Array || w instanceof Float64Array) && (w = new Uint8Array(w.buffer, w.byteOffset, w.byteLength));
        ...
        169: function (f, g, h) {
          ...
          f.exports = (k = h(21), h(165), k.mode.CFB = function () {
            ...
            function n(p, q, u, v) {
              var w,
                x = this._iv;
              x ? (w = x.slice(0), this._iv = 0) : w = this._prevBlock;
              v.encryptBlock(w, 0);
              for (var y = 0; y < u; y++) {
                p[q + y] ^= w[y];
              }
          ...
          f.exports = (k = h(21), h(165), k.mode.CTRGladman = function () {
            ...
            m.Encryptor = m.extend({
              processBlock: function (q, u) {
                ...
                {
                  A && (B = this._counter = A.slice(0), this._iv = 0);
                  o(B);
                  continue;
                }
                {
          ...
          f.exports = (m = h(21), h(165), m.mode.OFB = (k = m.lib.BlockCipherMode.extend(), l = k.Encryptor = k.extend({
            processBlock: function (p, q) {
              var v = this._cipher,
                ...
                x = this._iv,
                y = this._keystream;
              x && (y = this._keystream = x.slice(0), this._iv = 0);
              v.encryptBlock(y, 0);
              for (var z = 0; z < w; z++) {
                p[q + z] ^= y[z];
              }
        ...
        696: function (f, g, h) {
          ...
          f.exports = (k = h(21), h(754), h(636), h(506), h(165), function () {
            ...
            function z() {
              ...
              for (B[0] = B[0] + 1295307597 + this._b | 0, B[1] = B[1] + 3545052371 + (B[0] >>> 0 < w[0] >>> 0 ? 1 : 0) | 0, B[2] = B[2] + 886263092 + (B[1] >>> 0 < w[1] >>> 0 ? 1 : 0) | 0, B[3] = B[3] + 1295307597 + (B[2] >>> 0 < w[2] >>> 0 ? 1 : 0) | 0, B[4] = B[4] + 3545052371 + (B[3] >>> 0 < w[3] >>> 0 ? 1 : 0) | 0, B[5] = B[5] + 886263092 + (B[4] >>> 0 < w[4] >>> 0 ? 1 : 0) | 0, B[6] = B[6] + 1295307597 + (B[5] >>> 0 < w[5] >>> 0 ? 1 : 0) | 0, B[7] = B[7] + 3545052371 + (B[6] >>> 0 < w[6] >>> 0 ? 1 : 0) | 0, B[7] >>> 0 < w[7] >>> 0 ? this._b = 1 : this._b = 0, C = 0; C < 8; C++) {
                var D = A[C] + B[C],
                  E = 65535 & D,
                  F = D >>> 16,
                  G = ((E * E >>> 17) + E * F >>> 15) + F * F,
        ...
        298: function (f, g, h) {
          ...
          f.exports = (k = h(21), h(754), h(636), h(506), h(165), function () {
            ...
            function z() {
              ...
              for (D[0] = D[0] + 1295307597 + this._b | 0, D[1] = D[1] + 3545052371 + (D[0] >>> 0 < w[0] >>> 0 ? 1 : 0) | 0, D[2] = D[2] + 886263092 + (D[1] >>> 0 < w[1] >>> 0 ? 1 : 0) | 0, D[3] = D[3] + 1295307597 + (D[2] >>> 0 < w[2] >>> 0 ? 1 : 0) | 0, D[4] = D[4] + 3545052371 + (D[3] >>> 0 < w[3] >>> 0 ? 1 : 0) | 0, D[5] = D[5] + 886263092 + (D[4] >>> 0 < w[4] >>> 0 ? 1 : 0) | 0, D[6] = D[6] + 1295307597 + (D[5] >>> 0 < w[5] >>> 0 ? 1 : 0) | 0, D[7] = D[7] + 3545052371 + (D[6] >>> 0 < w[6] >>> 0 ? 1 : 0) | 0, D[7] >>> 0 < w[7] >>> 0 ? this._b = 1 : this._b = 0, E = 0; E < 8; E++) {
                var F = C[E] + D[E],
                  G = 65535 & F,
                  H = F >>> 16,
                  I = ((G * G >>> 17) + G * H >>> 15) + H * H,
            ...
            C.RIPEMD160 = B.extend({
              ...
              _doProcessBlock: function (Q, T) {
                ...
                for (a3 = Y = a9[0], a4 = Z = a9[1], a5 = a0 = a9[2], a6 = a1 = a9[3], a7 = a2 = a9[4], V = 0; V < 80; V += 1) {
                  a8 = Y + Q[T + ac[V]] | 0;
                  V < 16 ? a8 += K(Z, a0, a1) + aa[0] : V < 32 ? a8 += L(Z, a0, a1) + aa[1] : V < 48 ? a8 += M(Z, a0, a1) + aa[2] : V < 64 ? a8 += N(Z, a0, a1) + aa[3] : a8 += O(Z, a0, a1) + aa[4];
                  a8 |= 0;
                  a8 = P(a8, ae[V]);
                  a8 = a8 + a2 | 0;
                  Y = a2;
                  ...
                  Z = a8;
                  a8 = a3 + Q[T + ad[V]] | 0;
                  V < 16 ? a8 += O(a4, a5, a6) + ab[0] : V < 32 ? a8 += N(a4, a5, a6) + ab[1] : V < 48 ? a8 += M(a4, a5, a6) + ab[2] : V < 64 ? a8 += L(a4, a5, a6) + ab[3] : a8 += K(a4, a5, a6) + ab[4];
                  a8 |= 0;
                  a8 = P(a8, af[V]);
                  a8 = a8 + a7 | 0;
                  a3 = a7;
          ...
          f.exports = (y = j(21), m = y, p = m.lib, q = p.WordArray, u = p.Hasher, v = m.algo, w = [], x = v.SHA1 = u.extend({
            ...
            _doProcessBlock: function (A, B) {
              for (var D = this._hash.words, E = D[0], F = D[1], G = D[2], H = D[3], I = D[4], J = 0; J < 80; J++) {
                ...
                J < 20 ? L += 1518500249 + (F & G | ~F & H) : J < 40 ? L += 1859775393 + (F ^ G ^ H) : J < 60 ? L += (F & G | F & H | G & H) - 1894007588 : L += (F ^ G ^ H) - 899497514;
                I = H;
                H = G;
                G = F << 30 | F >>> 2;
                F = E;
        ...
        240: function (f, g, h) {
          ...
          f.exports = (k = h(21), function (m) {
            ...
            w.WordArray = u.extend({
              init: function (y, z) {
                y = this.words = y || [];
                z != m ? this.sigBytes = z : this.sigBytes = 8 * y.length;
              },
              toX32: function () {
    ...
    (() => {
      ...
      class k {
        ...
        async superWelfare_receiveRedPacket() {
          try {
            ...
            if (B.success) {
              ...
              if (B.obj.extraGiftList?.["length"]) {
                C = C.concat(B.obj.extraGiftList);
              }
          ...
          try {
            ...
            if (z?.["success"]) {
              for (let A of z?.["obj"] || []) {
                ...
                if (A.receiveHour === B) {
                  await this.memberDay_receiveRedPacket(A.receiveHour);
                }
              }
            } else {
        ...
        async memberDay_redPacketStatus() {
          try {
            ...
            if (z?.["success"]) {
              ...
              $.log("[" + (this.userName || this.index) + "][INFO] 会员日合成列表: " + D.join(", "));
              if (this.memberDay_redPacket_map[C]) {
        ...
        async bee_indexData() {
          try {
            ...
            let B = await this.fetch(A);
            if (!B?.["success"]) {
              return $.log("[" + (this.userName || this.index) + "][ERROR] 进入采蜜游戏主页失败: " + (B?.["errorMessage"] || (B ? JSON.stringify(B) : "无返回")));
            }
            let {
              friendAwards: E = [],
              gameNum: F = 0,
            ...
            if (!C?.["success"]) {
              return $.log("[" + (this.userName || this.index) + "][ERROR] 获取采蜜任务详情失败: " + (C?.["errorMessage"] || (C ? JSON.stringify(C) : "无返回")));
            }
            for (let I of C?.["obj"]?.["taskDetail"] || []) await this.bee_receiveHoney(I);
            let D = await this.fetch(A);
            if (!D?.["success"]) {
              return $.log("[" + (this.userName || this.index) + "][ERROR] 获取采蜜游戏丰蜜失败: " + (D?.["errorMessage"] || (D ? JSON.stringify(D) : "无返回")));
            }
        ...
        async coupon_list(y = 1, z = 100) {
          try {
            ...
            if (E.length > 0) {
              $.log("[" + (this.userName || this.index) + "][INFO] 大额优惠券:");
              $.log(E.map(F => "[" + (this.userName || this.index) + "][INFO] " + F.couponName + ", 过期时间: " + F.invalidTm).join("\n"));
            }
          } catch (F) {
            this.ckStatus = !1;
            $.log("[" + (this.userName || this.index) + "][ERROR] " + F + "\n");
      ...
      async function s(y, z) {
        if (y) {
          $.isNode() ? await notify.sendNotify($.name, y) : $.msg($.name, $.title || "", y, z);
        }
      }
      function t(y) {
        if (y) {
      ...
      function v(y, z = "debug") {
        if ("true" === $.is_debug) {
          $.log("\n-----------" + z + "------------\n");
          $.log("string" == typeof y ? y : $.toStr(y) || "debug error => t=" + y);
          $.log("\n-----------" + z + "------------\n");
        }
      }
      function w(y) {
